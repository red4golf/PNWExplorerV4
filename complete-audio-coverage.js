import { audioService } from './server/audio-service.ts';
...
async function generateAudioForLocation(locationId, locationName, script) {
  try {
...
async function completeAudioCoverage() {
  ...
  try {
    ...
    locationsNeedingAudio.forEach(loc => {
